export const ToggleSetting = ({ label, active, onToggle }: { label: string, active: boolean, onToggle: () => void }) => (
    <div className="bg-white p-5 rounded-3xl shadow-sm border border-gray-50 flex items-center justify-between transition-all">
        <span className="text-[#1E293B] font-bold ml-2">{label}</span>
        <button
            onClick={onToggle}
