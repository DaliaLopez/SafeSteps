    ...
    return (
        <div className="min-h-screen pb-10">
            ...
            <main className="max-w-md mx-auto px-6 space-y-8 pb-8">
                ...
                <button
                    onClick={logout}
                    className="sticky bottom-6 w-full bg-[#FF2D2D] text-white p-3 rounded-2xl font-bold flex items-center justify-center gap-3 shadow-xl shadow-red-100 active:scale-95 transition-all mt-10"
                >
                    <LogOut size={22} />
                    Cerrar sesión
                </button>
